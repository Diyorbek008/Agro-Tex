    ...
    return (
        ...
        <div>
            <div className={`${open ? 'overflow-hidden' : 'overflow-auto'}`}>
                ...
                {/* responsive navbar  */}
                <div className='max-1000:block max-1500:hidden'>
                    <div className={`${open ? 'block' : 'hidden'} transition-transform absolute flex flex-col right-0 bg-[#2F7B80] rounded-l-2xl z-10`}>
            ...
            <div className='py-9'>
                <header className='w-full max-w-[1440px] px-5 mx-auto'>
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='xl:flex xl:items-center max-630:hidden'>
                            <Link to='/'>
